        ...
        <div className="DictSearchListSection">
          {result.map((result) => (
            <div className="OneDictionaryCardSection">
              <div className="OneDictionaryCardList" key={result.id} onClick={() => history.push(`/dict/detail/${result.dictId}`)}>
                <div className="OneDictionaryCardList DictListTitle">{result.title}</div>
                <div className="OneDictionaryCardList DictListSummary">{result.summary}</div>
                <div className="OneDictionaryCardList DictWriteInfo">
                  ...
                  <div className="OneDictionaryCardList DictListLikeCount">{result.likeCount}</div>
                </div>
              </div>
            </div>
          ))}
